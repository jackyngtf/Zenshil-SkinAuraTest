...
export default function SkinVoiceMembrane({
  ...
  // Generate standard SVG wave paths dynamically for seamless interpolation
  const getWavePath = (y1: number, y2: number, y3: number, y4: number) => {
    return `M 15 40 C 45 ${y1}, 75 ${y2}, 90 40 C 105 ${y3}, 135 ${y4}, 165 40`;
  };

  // Wave path sets for morphing animations based on selected mood
  const wavePaths = useMemo(() => {
    switch (moodState) {
      case 'tired':
        return {
          wave1: [
            getWavePath(37, 43, 37, 43),
            getWavePath(43, 37, 43, 37),
            getWavePath(37, 43, 37, 43),
          ],
          wave2: [
            getWavePath(42, 38, 42, 38),
            getWavePath(38, 42, 38, 42),
            getWavePath(42, 38, 42, 38),
          ],
          duration: 6.0,
        };
      case 'pressure':
        // Tighter, denser tension wave
        return {
          wave1: [
            "M 15 40 C 35 26, 45 54, 65 40 C 85 26, 95 54, 115 40 C 135 26, 145 54, 165 40",
            "M 15 40 C 35 54, 45 26, 65 40 C 85 54, 95 26, 115 40 C 135 54, 145 26, 165 40",
            "M 15 40 C 35 26, 45 54, 65 40 C 85 26, 95 54, 115 40 C 135 26, 145 54, 165 40",
          ],
          wave2: [
            "M 15 40 C 30 48, 50 32, 70 40 C 90 48, 110 32, 130 40 C 150 48, 160 32, 165 40",
            "M 15 40 C 30 32, 50 48, 70 40 C 90 32, 110 48, 130 40 C 150 32, 160 48, 165 40",
            "M 15 40 C 30 48, 50 32, 70 40 C 90 48, 110 32, 130 40 C 150 48, 160 32, 165 40",
          ],
          duration: 2.5,
        };
      case 'rest':
        return {
          wave1: [
            getWavePath(20, 60, 20, 60),
            getWavePath(60, 20, 60, 20),
            getWavePath(20, 60, 20, 60),
          ],
          wave2: [
            getWavePath(55, 25, 55, 25),
            getWavePath(25, 55, 25, 55),
            getWavePath(55, 25, 55, 25),
          ],
          duration: 4.5,
        };
      case 'renewal':
        // Optimistic upward-curved waves
        return {
          wave1: [
            "M 15 45 C 45 15, 75 5, 95 30 C 115 10, 145 0, 165 20",
            "M 15 45 C 45 25, 75 15, 95 38 C 115 18, 145 8, 165 28",
            "M 15 45 C 45 15, 75 5, 95 30 C 115 10, 145 0, 165 20",
          ],
          wave2: [
            "M 15 48 C 45 22, 75 12, 95 36 C 115 16, 145 6, 165 26",
            "M 15 48 C 45 12, 75 2, 95 28 C 115 8, 145 -2, 165 18",
            "M 15 48 C 45 22, 75 12, 95 36 C 115 16, 145 6, 165 26",
          ],
          duration: 3.2,
        };
      default: // idle
        return {
          ...
          wave2: [
            getWavePath(50, 30, 50, 30),
            getWavePath(30, 50, 30, 50),
            getWavePath(50, 30, 50, 30),
          ],
          duration: 5.0,
        };
