...
const elementThemes: Record<string, ElementTheme> = {
  late_night: { // Q4 A (Sleep), Q6 B (Irregular)
    bgGradient: 'from-blue-50/65 via-violet-50/40 to-stone-50/35',
    buttonBorder: 'border-blue-300/55',
    buttonActiveBg: 'bg-blue-50/70',
    rippleColor: 'rgba(147,197,253,0.74)',
    auraTint: 'rgba(147, 197, 253, 0.34)',
    auraSecondary: 'rgba(196, 181, 253, 0.22)',
  },
  burnout: { // Q4 B (Relaxation), Q6 A (High-speed)
    bgGradient: 'from-orange-50/65 via-rose-50/35 to-stone-50/35',
    buttonBorder: 'border-orange-300/55',
    buttonActiveBg: 'bg-orange-50/75',
    rippleColor: 'rgba(253,186,116,0.78)',
    auraTint: 'rgba(251, 146, 60, 0.32)',
    auraSecondary: 'rgba(251, 113, 133, 0.2)',
  },
  preventive: { // Q4 C (Time), Q6 D (Disciplined)
    bgGradient: 'from-teal-50/65 via-cyan-50/35 to-amber-50/25',
    buttonBorder: 'border-teal-300/55',
    buttonActiveBg: 'bg-teal-50/75',
    rippleColor: 'rgba(94,234,212,0.76)',
    auraTint: 'rgba(45, 212, 191, 0.3)',
    auraSecondary: 'rgba(251, 191, 36, 0.18)',
  },
  overworked: { // Q4 D (Energy), Q6 C (Steady/Tiring)
    bgGradient: 'from-stone-50/75 via-blue-50/30 to-amber-50/25',
    buttonBorder: 'border-amber-300/50',
    buttonActiveBg: 'bg-amber-50/62',
    rippleColor: 'rgba(253,224,171,0.76)',
    auraTint: 'rgba(191, 219, 254, 0.26)',
    auraSecondary: 'rgba(214, 211, 209, 0.28)',
  },
};
